...
class ResumeParser:
    ...
    def parse_skills(self, resume_segment):
        ...
        labels = ['skills', 'technical skills','TECHNICAL SKILLS', 'expertise', 'technologies', 'proficiencies']
        skills = []
    ...
    #     skill_labels = ['skills', 'Technical Skills', 'expertise', 'technologies', 'proficiencies']        
    #     skills = []
    #     for item in resume_segment:
    #         if any(label.lower() in item.lower() for label in skill_labels):
    #             # Split and process the potential skill entries
    #             for elem in splitter.split(item):
    #                 cleaned_skill = elem.strip()
    #                 if cleaned_skill and not cleaned_skill.isdigit():
    #                     skills.append(cleaned_skill)
        
    #     # Deduplicate and store the extracted skills
    ...
    def find_person_name(self, items):
        ...
        classes = ["person name", "email", "title"]
        for item in items: 
